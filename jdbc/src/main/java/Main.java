...
public class Main {
    static void main() {
        ...
        Company company = new Company(1,"testeCompany");
        AddEntities.addEntityCompany(company);
        //todo contratando
        ...
        System.out.println("vindo do banco");
        GetEntities.getAllEmployeesOfCompany(company);
        System.out.println();
        ...
        DeleteEntities.deletePaycheck(LocalDate.of(1800, 1, 4), "06");
        allEmployees.forEachRemaining(e -> {System.out.println(e.getName()); GetEntities.getAllPaychecksOfEmployee(e); });
        GetEntities.getAllEmployeesOfCompany(company);
