...
public class Company {
    ...
    public void hire(String id, String name, double salary, LocalDate dateOfEmployment, String jobTitle){
        ...
        Employee employee = new Employee(id, name, salary, dateOfEmployment, jobTitle, this.id);
        employeeList.add(employee);
        AddEntities.addEntityEmployee(employee);
    }
    ...
    public void fire(String id){
        ...
        DeleteEntities.deleteEmployee(fired.getId());
    }
    ...
    public void increaseSalary(String id, double newSalary){
        ...
        UpdateEntities.updateEmploye(employee);
    }
    ...
    public void setName(String name) {
        this.name = name;
        UpdateEntities.updateCompany(this);
    }
